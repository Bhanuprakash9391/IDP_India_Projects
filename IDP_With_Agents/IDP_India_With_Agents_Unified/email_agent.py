...
class EmailAgent:
    ...
    def extract_email_info_from_query(self, query: str, per_file_data: Dict) -> Dict:
        ...
        try:
            ...
            if json_match:
                ...
                email_info['recipient_name'] = recipient_name
                logger.info(f"Successfully extracted email info: recipient={recipient_email}, recipient_name={recipient_name}, include_excel={email_info.get('include_excel', False)}")
                return email_info
            else:
    ...
    def _extract_name_from_email(self, email: str) -> str:
        ...
        try:
            ...
            # Remove common email suffixes and numbers at the end
            username = re.sub(r'[._0-9]+$', '', username)
    ...
    def prepare_email_content(self, email_info: Dict, per_file_data: Dict) -> Dict:
        ...
        body = self._format_email_body(email_info['body'], email_data, filtered_data, email_info.get('recipient_name', ''))
    ...
    def _format_email_body(self, body_request: str, email_data: List[Dict], filtered_data: Dict, recipient_name: str = "") -> str:
        ...
        try:
            ...
            # Use personalized greeting if recipient name is available
            ...
            2. Directly addresses the user's request in a professional tone
            3. Presents the extracted information in a clear, organized manner
            4. Uses proper email formatting with paragraphs, bullet points, and clear structure
            5. Highlights the most important information first
            6. Is easy to read and understand
            7. Includes a professional closing with signature "Soothsayer Analytics Team, India"
            8. DO NOT include any JSON formatting, brackets, or technical data structures
            9. Make it sound natural and human-written
            ...
            return self._fallback_email_formatting(body_request, email_data, filtered_data, recipient_name)
    ...
    def _fallback_email_formatting(self, body_request: str, email_data: List[Dict], filtered_data: Dict, recipient_name: str = "") -> str:
...
Best regards,
Soothsayer Analytics Team, India
"""
