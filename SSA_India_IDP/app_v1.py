    ...
    if st.session_state.per_file_data:
        ...
        <div style="background: #FFFFFF; padding: 1.5rem; border-radius: 8px; text-align: center; 
            ...
            <ul style="text-align: left; max-width: 550px; margin: 0 auto; 
                ...
                <li><strong style="color: #6B2190;">Table Detection & Extraction</strong> - Automatic table parsing</li>
                <li><strong style="color: #6B2190;">Multi-Database Architecture</strong> - Separate stores for text, tables, images</li>
